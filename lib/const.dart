...
const bgSecondaryColor= Color(0xff393939);
...
TextStyle regular13WhiteText=GoogleFonts.poppins(color: Colors.white,fontSize: 14,fontWeight: FontWeight.w400);
TextStyle regular15WhiteText=GoogleFonts.poppins(color: Colors.white,fontSize: 16,fontWeight: FontWeight.w400);
TextStyle regular16WhiteBoldText=GoogleFonts.poppins(color: Colors.white,fontSize: 16,fontWeight: FontWeight.w500);
TextStyle regular15WhiteBoldText=GoogleFonts.poppins(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w500);
